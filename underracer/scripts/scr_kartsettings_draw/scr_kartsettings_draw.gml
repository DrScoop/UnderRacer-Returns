function scr_kartsettings_draw() {
	...
	d3d_draw_wall(x-(kartwidth)*camsin,y-(kartwidth)*camcos,z+(kartheight)+vibration+vibration,x+(kartwidth*1.1)*camsin,y+(kartwidth)*camcos,z+(kartbottom)+vibration+vibration,tex,1,1)
