...
draw_text(12,5,string_hash_to_newline(string(global.char1)))
draw_text(12,5+16,string_hash_to_newline("Speed: "+string(target.speed)))
if global.cmpn_showraceinfo==false{
draw_text(12,5+32,string_hash_to_newline("Lap: "+string(target.lap)))}
if global.cmpn_showraceinfo==true{
draw_text(12,5+32,string_hash_to_newline("Lap: "+string(target.lap)+" / "+string(global.lap_limit)))}
draw_text(12,5+48,string_hash_to_newline("Player : "+string(target.player)))
draw_text(12,5+64,string_hash_to_newline("Magic : "+string(round(target.ability_timer))+" %"))
draw_text(12,5+80,string_hash_to_newline("Attack : "+string(target.ability)))
//HUD Powerup Box
