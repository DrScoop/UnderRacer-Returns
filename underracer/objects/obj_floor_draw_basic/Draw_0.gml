...
if variable_instance_exists(id, z) && floortex != undefined
  d3d_primitive_begin_texture(pr_trianglelist, background_get_texture(floortex));
      d3d_vertex_normal_texture(x, y, zbottom+z, 0, 0, 1, 0, 0,floortex);
      d3d_vertex_normal_texture(x + 32, y, zbottom+z, 0, 0, 1, 1, 0,floortex);
      d3d_vertex_normal_texture(x + 32, y + 32, zbottom+z, 0, 0, 1, 1, 1,floortex);
      //
      d3d_vertex_normal_texture(x + 32, y + 32, zbottom+z, 0, 0, 1, 1, 1,floortex);
      d3d_vertex_normal_texture(x, y + 32, zbottom+z, 0, 0, 1, 0, 1,floortex);
      d3d_vertex_normal_texture(x, y, zbottom+z, 0, 0, 1, 0, 0,floortex);
  d3d_primitive_end();
  d3d_primitive_begin_texture(pr_trianglelist, background_get_texture(rooftex));
      d3d_vertex_normal_texture(x, y, ztop+z, 0, 0, -1, 0, 0,floortex);
      d3d_vertex_normal_texture(x + 32, y, ztop+z, 0, 0, -1, 1, 0,floortex);
      d3d_vertex_normal_texture(x + 32, y + 32, ztop+z, 0, 0, -1, 1, 1,floortex);
      //
      d3d_vertex_normal_texture(x + 32, y + 32, ztop+z, 0, 0, -1, 1, 1,floortex);
      d3d_vertex_normal_texture(x, y + 32, ztop+z, 0, 0, -1, 0, 1,floortex);
      d3d_vertex_normal_texture(x, y, ztop+z, 0, 0, -1, 0, 0,floortex);
  d3d_primitive_end()
}}
