...
var curcolor,curalpha,name,time,factor,frameprev,framenext,valueprev,shape,tex,xpos,zpos,xwidth,ywidth,zwidth;
...
for (shape=1;shape<=maxshape;shape+=1) if !shapes[shape,3]
{
  ...
  d3d_transform_add_translation(xpos,0,zpos);
