...
var tex_front;
tex_front = tex_librarby_front;
var tex_side_0;
tex_side_0 = tex_librarby_side;
var tex_side_1;
tex_side_1 = tex_librarby_side;
var tex_side_2;
tex_side_2 = tex_librarby_side;
...
d3d_transform_add_rotation_z(direction);
d3d_transform_add_translation(x,y,z);
d3d_draw_wall(-112,0,64,112,0,0,tex,1,1);
d3d_transform_set_identity();
// side 0
