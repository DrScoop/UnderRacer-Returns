...
if bot=false{
if player=1{
if keyboard_check(global.control_pl1cam_kb) or gamepad_check_button(1,global.control_pl1cam_jk){looktimer-=2.5 camobj.adddir=180 camobj.DX = -40}
if keyboard_check_released(global.control_pl1cam_kb) or gamepad_check_button_released(1,global.control_pl1cam_jk){mdlspr_down=mdlspr_down_ref camobj.adddir=0 camobj.DX = -20 looktimer=20}
}
if player=2{
if keyboard_check(global.control_pl2cam_kb) or gamepad_check_button(2,global.control_pl2cam_jk){looktimer-=2.5 camobj.adddir=180 camobj.DX = -40}
if keyboard_check_released(global.control_pl2cam_kb) or gamepad_check_button_released(2,global.control_pl2cam_jk){mdlspr_down=mdlspr_down_ref camobj.adddir=0 camobj.DX = -20 looktimer=20}
}}
}
}
...
if keyboard_check(global.control_pl1move_kb) or gamepad_check_button(1,global.control_pl1move_jk){speed+=kart_accel}
if keyboard_check(global.control_pl1break_kb) or gamepad_check_button(1,global.control_pl1break_jk){speed-=kart_accel}
if can_turn=true{
if keyboard_check(global.control_pl1left_kb) or gamepad_check_button(1,global.control_pl1left_jk){direction+=((driftadd/4)+(kart_turn/1.25))/2 driftadd+=1}
if keyboard_check(global.control_pl1right_kb) or gamepad_check_button(1,global.control_pl1right_jk){direction-=((driftadd/4)+(kart_turn/1.25))/2 driftadd+=1}
}
if keyboard_check_pressed(global.control_pl1use_kb) or gamepad_check_button_pressed(1,global.control_pl1use_jk){powerup_trigger=true}
if keyboard_check(global.control_pl1special_kb) or gamepad_check_button(1,global.control_pl1special_jk){ability_trigger=true}
if !keyboard_check(global.control_pl1right_kb) and !gamepad_check_button(1,global.control_pl1right_jk) and 
!keyboard_check(global.control_pl1left_kb) and !gamepad_check_button(1,global.control_pl1left_jk){driftadd=0}
}

//Player 2 Controls
if player=2{
//Controls (Turning, Acceleration, Braking, Speed limits, Etc...)
if keyboard_check(global.control_pl2move_kb) or gamepad_check_button(2,global.control_pl2move_jk){speed+=kart_accel}
if keyboard_check(global.control_pl2break_kb) or gamepad_check_button(2,global.control_pl2break_jk){speed-=kart_accel}
if can_turn=true{
if keyboard_check(global.control_pl2left_kb) or gamepad_check_button(2,global.control_pl2left_jk){direction+=((driftadd/4)+(kart_turn/2.25))/2 driftadd+=2}
if keyboard_check(global.control_pl2right_kb) or gamepad_check_button(2,global.control_pl2right_jk){direction-=((driftadd/4)+(kart_turn/2.25))/2 driftadd+=2}
}
if keyboard_check_pressed(global.control_pl2use_kb) or gamepad_check_button_pressed(2,global.control_pl2use_jk){powerup_trigger=true}
if keyboard_check(global.control_pl2special_kb) or gamepad_check_button(2,global.control_pl2special_jk){ability_trigger=true}
if !keyboard_check(global.control_pl2right_kb) and !gamepad_check_button(2,global.control_pl2right_jk) and 
!keyboard_check(global.control_pl2left_kb) and !gamepad_check_button(2,global.control_pl2left_jk){driftadd=0}
}
