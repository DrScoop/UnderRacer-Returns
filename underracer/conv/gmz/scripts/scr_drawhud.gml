...
draw_text(12,6+16,"Speed: "+string(target.speed))
draw_text(12,6+32,"Lap: "+string(target.lap)+" / "+string(global.lap_limit))
draw_text(12,6+48,"Player : "+string(target.player))
draw_text(12,6+64,"Magic : "+string(round(target.ability_timer))+" %")
draw_text(12,6+80,"Attack : "+string(target.ability))
...
draw_text(12+42,432+16,string(target.powerup))
//HUD Timer
draw_sprite_ext(spr_hud_timebox,-1,496,0,1,1,0,c_white,1)
draw_text(496+46,12,string(target.minutes)+" : "+string(target.seconds))
draw_set_alpha(1);
d3d_set_hidden(true);
...
//First Text Drawn outside this script, Check object
draw_text(12,6+16,"Speed: "+string(target.speed))
draw_text(12,6+32,"Lap: "+string(target.lap))
draw_text(12,6+48,"Player : "+string(target.player))
draw_text(12,6+64,"Magic : "+string(round(target.ability_timer))+" %")
draw_text(12,6+80,"Attack : "+string(target.ability))
//draw_text(12,12+96,"Position: "+string(target.race_position))
...
draw_text(12+42,192+16,string(target.powerup))
//HUD Timer
draw_sprite_ext(spr_hud_timebox,-1,496,0,1,1,0,c_white,1)
draw_text(496+46,12,string(target.minutes)+" : "+string(target.seconds))
draw_set_alpha(1);
